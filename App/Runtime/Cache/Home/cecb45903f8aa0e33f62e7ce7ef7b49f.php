...
<html>
		...
		<div class="pr-head">
			...
			<ul class="prhd-nav">
				<li class="nav01 <?php if((ACTION_NAME) == "index"): ?>active<?php endif; ?>">
					<a href="index"><span>首页</span><span class="note">Home</span></a>
				</li>
	...
	<div class="pr-banner" style="background: url(/Public/index/images/news-zibanner.jpg) no-repeat center;"></div>
		...
		<div class="news-list">
			<div class="news-listcnt">
				...
				<ul class="news-listbox">
					<?php if(is_array($news)): $i = 0; $__LIST__ = $news;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$i): $mod = ($i % 2 );++$i;?><a href="/Home/Index/newsdetail/id/<?php echo ($i["articleId"]); ?>">
						<li>
							<div class="date">
