...
<html>
	...
	<div class="pr-banner" style="background: url(/Public/index/images/enzyme-banner01.jpg) no-repeat center;"></div>

	<div class="pr-cnt">
		<div class="enzyme-top">
			<ul class="ennavbox">
				<li class="nmb01 <?php if(($id) == "6"): ?>active<?php endif; ?>">
					<a href="/Home/Index/fertilizer/id/6" class="prnav01 sprite"></a>
				</li>
				<li class="nmb02 <?php if(($id) == "7"): ?>active<?php endif; ?>">
					<a href="/Home/Index/fertilizer/id/7" class="prnav02 sprite"></a>
				</li>
				<li class="nmb03 <?php if(($id) == "8"): ?>active<?php endif; ?>">
					<a href="/Home/Index/fertilizer/id/8" class="prnav03 sprite"></a>
				</li>
				<li class="nmb04 <?php if(($id) == "9"): ?>active<?php endif; ?>">
					<a href="/Home/Index/fertilizer/id/9" class="prnav04 sprite"></a>
				</li>
			</ul>
		</div>
		<div class="en-cnt">
	...
	<div class="pr-cnt">
		<div class="pr-banner" style="background: url(/Public/index/images/en-bmbanner.png) no-repeat center;"></div>
	</div>
