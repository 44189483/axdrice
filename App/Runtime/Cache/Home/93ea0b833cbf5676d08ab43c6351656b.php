...
<html>
	...
	<head>
		...
		<link rel="stylesheet" href="/axd-tp/Public/index/js/swiper/idangerous.swiper.css" />
	</head>
	...
	<body>
		...
		<div class="pr-head">
			<div class="pr-headlogo">
				<a href="index.html"><img src="/axd-tp/Public/index/images/prhd-logo.jpg" alt="" /></a>
			</div>
			<ul class="prhd-nav">
				...
				<li class="nav03 <?php if((ACTION_NAME) == "fertilizer"): ?>active<?php endif; ?>">
					<a href="/axd-tp/Home/Index/fertilizer"><span>酵素与生物肥</span><span class="note">Enzyme&Bio-fertilizer</span></a>
				</li>
				<li class="nav02 <?php if((ACTION_NAME) == "about"): ?>active<?php endif; ?>">
					<a href="/axd-tp/Home/Index/about"><span>关于我们</span><span class="note">About us</span></a>
				</li>
				<li class="nav04 <?php if((ACTION_NAME) == "news|newsdetail"): ?>active<?php endif; ?>">
					<a href="/axd-tp/Home/Index/news"><span>新闻资讯</span><span class="note">News</span></a>
				</li>
			</ul>
		</div>

	<div class="pr-banner" style="background: url(/axd-tp/Public/index/images/news-zibanner.jpg) no-repeat center;"></div>
	...
	<div class="pr-cnt">
		<div class="news-list">
			<div class="news-listcnt">
				...
				<ul class="news-listbox">
					<?php if(is_array($news)): $i = 0; $__LIST__ = $news;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$i): $mod = ($i % 2 );++$i;?><a href="/axd-tp/Home/Index/newsdetail/id/<?php echo ($i["articleId"]); ?>">
						<li>
							<div class="date">
								<span><?php echo ($i["day"]); ?></span>
								<span class="date01"><?php echo ($i["month"]); ?></span>
							</div>
							<div class="news-listboxtext">
								<h3><?php echo ($i["articleTitle"]); ?></h3>
								<?php echo (msubstr($i["articleContent"],0,40,'utf-8')); ?>
							</div>

						</li>
					</a><?php endforeach; endif; else: echo "" ;endif; ?>
				</ul>
				<div class="news-prev"><?php echo ($page); ?></div>
			</div>
		</div>
	</div>
		...
		<div style='background: url(/axd-tp/Public/index/images/ftbanner_01.jpg) no-repeat top center;' class="foot-banner"></div>

		<!--foot-nav开始-->

		<!--网站脚本加载模块开始-->
		<script src="/axd-tp/Public/index/js/jquery-1.7.1.min.js"></script>
		<script src="/axd-tp/Public/index/js/swiper/idangerous.swiper.min.js"></script>
