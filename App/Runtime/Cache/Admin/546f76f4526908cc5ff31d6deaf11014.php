...
<body class="bodyGrey">
	...
	<div class="table01">
		<form action="/axd/index.php/Admin/Product/save/act/edit" method="POST" name="form1" enctype="multipart/form-data" onSubmit="return checkform(this);">
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			<?php if(($row['productImg']) != ""): ?><tr class="row">
					<th>&nbsp;</th>
					<td>
					  	<img src="/axd/<?php echo ($row["productImg"]); ?>" width="200"/>
