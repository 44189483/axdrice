...
<body class="bodyGrey">
	...
	<div class="table01">
	<form action="/index.php/Admin/Slide/save<?php if((sid) != ""): ?>/sid/<?php echo ($sid); endif; ?>" method="POST" enctype="multipart/form-data" name="form1" <?php if((sid) == "0"): ?>onSubmit="return checkform(this)"<?php endif; ?>>

		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			<?php if(($row['slideImg']) != ""): ?><tr>
			  <th>&nbsp;</th>
			  <td>
			  	<img src="/<?php echo ($row["slideImg"]); ?>" width="200"/>
	...
	<div class="mainBanner">
		...
		<ul>
			<?php if(is_array($rows)): $i = 0; $__LIST__ = $rows;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$i): $mod = ($i % 2 );++$i;?><li>
				<a href="/index.php/Admin/Slide/index/sid/<?php echo ($i["slideId"]); ?>">
					<img src="/<?php echo ($i["slideImg"]); ?>" height="100" />
				</a>
				<span>(<?php echo ($i["ord"]); ?>)</span>
				<a class="del" href="/index.php/Admin/Slide/del/sid/<?php echo ($i["slideId"]); ?>" title="删除" onclick="return confirm('确认要删除？');"></a>
