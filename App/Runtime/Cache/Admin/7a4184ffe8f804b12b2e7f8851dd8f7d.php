...
<head>
	...
	<link rel="stylesheet" href="/axd/Public/editor//axd/Public/code/prettify.css" />
	...
	<script charset="utf-8" src="/axd/Public/editor//axd/Public/code/prettify.js"></script>
	<script>
		KindEditor.ready(function(K) {
				editor1 = K.create('textarea[name="content"]', {
				cssPath : '/axd/Public/editor/code/prettify.css',
...
<body class="bodyGrey">
	...
	<div class="table01">
		<form action="/axd/index.php/Admin/Article/save/<?php echo ($aid); ?>" method="POST" name="form1" enctype="multipart/form-data">
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			<?php if(($row['articleType']) == "0"): if(($row['articleImg']) != "''"): ?><tr class="row">
					<th>&nbsp;</th>
					<td>
					  	<img src="/axd/<?php echo ($row["articleImg"]); ?>" width="200"/>
