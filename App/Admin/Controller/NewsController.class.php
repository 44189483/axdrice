...
class NewsController extends Controller {
	...
	public function index(){
	    ...
	    // 进行分页数据查询
	    $rows = $article->where($where)->order('ord DESC,addDate DESC,articleId DESC')->limit($Page->firstRow.','.$Page->listRows)->select(); // $Page->firstRow 起始条数 $Page->listRows 获取多少条
